...
function PoistamaksuMUI(props) {
  ...
  const poistaMaksu = (id) => {
    return fetch(url + "/maksut/delete/" + id)
      ...
      >
        <Paper style={{ padding: '10px', margin: '30px' }}>
          <div style={{ textAlign: 'center' }}><br />
            <Button onClick={poistaMaksu.bind(null, props.id)} variant='contained' color='primary' style={{ marginRight: 20 }} startIcon={<DeleteOutlinedIcon />}>Poista maksu</Button>
